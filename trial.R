...
val_sample <- sample.int(nrow(data), 
                         size = 0.1*nrow(data))

val_question1_padded <- data[val_sample,]
val_question2_padded <- data[val_sample,]
val_is_duplicate <- train_labels$labels[val_sample]
